...
$CHECKED = "$PSScriptRoot/../versions/commontorizonmanifest"
...
$get = Invoke-WebRequest `
    -Uri "https://api.github.com/repos/commontorizon/commontorizon-manifest/issues?state=open"
...
if ($notCheckedIssues.Count -gt 0) {
    $ret.code = 1
    $ret.lines.Add("commontorizon/") | Out-Null
    $ret.lines.Add("commontorizon-manifest") | Out-Null
