...
$CHECKED = "$PSScriptRoot/../versions/vscodebitbake"
...
$get = Invoke-WebRequest `
    -Uri "https://api.github.com/repos/microhobby/vscode-bitbake/issues?state=open"
...
if ($notCheckedIssues.Count -gt 0) {
    ...
    $ret.lines.Add("vscode-bitbake") | Out-Null
