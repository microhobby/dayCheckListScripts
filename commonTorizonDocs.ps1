...
$CHECKED = "$PSScriptRoot/../versions/commontorizondocs"
...
$get = Invoke-WebRequest `
    -Uri "https://api.github.com/repos/commontorizon/Documentation/issues?state=open"
...
if ($notCheckedIssues.Count -gt 0) {
    ...
    $ret.lines.Add("Documentation") | Out-Null
