...
$CHECKED = "$PSScriptRoot/../versions/androidrepoissues"
...
$get = Invoke-WebRequest `
    -Uri "https://api.github.com/repos/microhobby/vscode-android-repo/issues?state=open"
...
if ($notCheckedIssues.Count -gt 0) {
    ...
    $ret.lines.Add("vscode-android-repo") | Out-Null
