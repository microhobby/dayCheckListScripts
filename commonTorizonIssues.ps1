...
$CHECKED = "$PSScriptRoot/../versions/commontorizon"
...
$get = Invoke-WebRequest `
    -Uri "https://api.github.com/repos/commontorizon/meta-common-torizon/issues?state=open"
...
if ($notCheckedIssues.Count -gt 0) {
    ...
    $ret.lines.Add("meta-common-torizon") | Out-Null
